...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({
  ...
  const mockWorkflows: AutomationWorkflow[] = [
    ...
    },
    {
      ...
      successRate: 98.5,
      triggerCount: 890,
      lastRun: 'Queued (Awaiting OCR File)',
      steps: [
        { id: '1', title: 'Open QuickBooks Window', action: 'Screen Vision OCR', status: 'Completed' },
        { id: '2', title: 'Extract Invoice PDF', action: 'Vision AI Reader', status: 'In Progress' },
        { id: '3', title: 'Send WhatsApp Alert', action: 'WhatsApp Business API', status: 'Pending' },
      ],
    },
    {
      id: 'wf_3',
      title: 'Zendesk Ticket Sentiment & Auto-Reply Dispatch',
      category: 'Browser',
      description: 'Scans unresolved Zendesk tickets, categorizes sentiment, and dispatches resolution.',
      status: 'Failed',
      successRate: 84.2,
      triggerCount: 450,
      lastRun: '5 mins ago (Webhook Auth Error)',
      steps: [
        { id: '1', title: 'Login to Zendesk API', action: 'OAuth Authentication', status: 'Completed' },
        { id: '2', title: 'Analyze Ticket Sentiment', action: 'Gemini LLM Classifier', status: 'Completed' },
        { id: '3', title: 'Dispatch Auto Reply', action: 'Zendesk Ticket Webhook', status: 'Failed' },
      ],
    },
    {
      id: 'wf_4',
      title: 'WhatsApp Lead Follow-Up & Instant Document Dispatch',
      category: 'WhatsApp',
      description: 'Automatically replies to incoming WhatsApp leads with requested PDF brochures.',
      status: 'Active',
      successRate: 100,
      triggerCount: 2150,
      lastRun: 'Just now',
      steps: [
        { id: '1', title: 'Listen for Message', action: 'WhatsApp Business Webhook', status: 'Completed' },
        { id: '2', title: 'Match Document Intent', action: 'Vector DB Semantic Search', status: 'Completed' },
        { id: '3', title: 'Send Media PDF', action: 'WhatsApp Document API', status: 'Completed' },
      ],
    },
    {
      id: 'wf_5',
      title: 'Daily Executive Email Summary & KPI Reporting',
      category: 'Email',
      description: 'Aggregates daily call logs and sales conversions into an executive digest email.',
      status: 'Pending',
      successRate: 96.0,
      triggerCount: 310,
      lastRun: 'Scheduled in 20 mins',
      steps: [
        { id: '1', title: 'Query Analytics Data', action: 'SQL Database Aggregator', status: 'Completed' },
        { id: '2', title: 'Generate HTML Summary', action: 'Template Renderer Engine', status: 'Pending' },
        { id: '3', title: 'Dispatch Email Digest', action: 'SendGrid Email API', status: 'Pending' },
      ],
    },
    {
      id: 'wf_6',
      title: 'HubSpot Pipeline Lead Rescoring Sync',
      category: 'CRM',
      description: 'Re-scores inbound lead records every 6 hours and updates deal stages in HubSpot.',
      status: 'Failed',
      successRate: 78.4,
      triggerCount: 180,
      lastRun: '12 mins ago (API Rate Limit)',
      steps: [
        { id: '1', title: 'Fetch Contacts List', action: 'HubSpot API v3', status: 'Completed' },
        { id: '2', title: 'Calculate Lead Score', action: 'Predictive Model Engine', status: 'Completed' },
        { id: '3', title: 'Update Deal Stage', action: 'HubSpot Patch Endpoint', status: 'Failed' },
      ],
    },
  ];
